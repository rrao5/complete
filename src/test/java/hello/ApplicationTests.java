...
public class ApplicationTests {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/people").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\",\"ssn\":\"123-45-1234\"}")).andExpect(
	...
	@Test
	public void shouldQueryEntityEncrypted() throws Exception {
		...
		mockMvc.perform(
				get("/people/search/findBySsn?ssn={name}", "123-45-1234")).andExpect(
				status().isOk()).andExpect(
				jsonPath("$._embedded.people[0].firstName").value(
						"Frodo"));
	}
	...
	public void shouldDeleteEntity() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(post("/people").content(
				"{ \"firstName\": \"Bilbo\", \"lastName\":\"Baggins\",\"ssn\":\"123-45-1234\"}")).andExpect(
						status().isCreated()).andReturn();
